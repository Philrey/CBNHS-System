...
public class thread_return_values extends SwingWorker<Integer, Object>{
    ...
    public thread_return_values(String toSearch,String select, String from, String where, int[] order, JTable tableName, JFrame jFrameName, JPanel dialogPanel, JLabel lbLoadingMessage, JProgressBar progressBar,int [] combineColumns,boolean toNameFormat,JLabel resultText) {
        this.select = select;
        this.from = from;
        this.where = where;
        this.order = order;
        ...
        this.lbLoadingMessage = lbLoadingMessage;
